...
const StudentAttendanceCard: React.FC<StudentAttendanceCardProps> = ({
  ...
  const classNameOrdinal = useMemo(
    () => toOrdinal(parseInt(className)),
    [className]
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {selectedDuration === SelectedDuration.Daily ? (
          <MemoizedDailyAttendanceStats
            morningStatus={morningStatus}
            afternoonStatus={afternoonStatus}
          />
        ) : (
          <MemoizedGenericAttendanceStats
...
const DailyAttendanceStats = (morningStatus, afternoonStatus) => {
  return (
...
const MemoizedDailyAttendanceStats = React.memo(DailyAttendanceStats);

const GenericAttendanceStats = (
  presentAttendance,
  totalAttendance
) => {
  return (
...
const MemoizedGenericAttendanceStats = React.memo(
  GenericAttendanceStats
);

export default React.memo(StudentAttendanceCard);
