...
const AttendanceActions: React.FC<ActionSheetProps> = ({
  isOpen,
  onClose,
  initialFocusRef,
  studentAttendanceData,
}) => {
  const { handleControlRoomNavigation } = useHandleNavigateToScreen(
    studentAttendanceData,
    onClose
  );
  ...
  return (
    ...
    >
      ...
      <ActionsheetContent>
        ...
        <ActionsheetItem
          onPress={() =>
            handleControlRoomNavigation(RouteNames.CaptureAttendance)
          }
        >
          <ActionsheetItemText>
            Capture Attendance
        ...
        <ActionsheetItem
          onPress={() =>
            handleControlRoomNavigation(RouteNames.AttendanceStats)
          }
        >
          <ActionsheetItemText>
